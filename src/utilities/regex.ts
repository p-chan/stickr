...
export const isStickrEmojiNameWithSuffix = new RegExp('^(' + emojiPrefix + '_)[0-9]+(_)[0-9]+(_)[0-9a-zA-Z]+$', 'g')
...
// alias:スタンプ_1234_1234_suffix
export const isStickrEmojiAliasNameWithSuffixRegex = new RegExp(
  '^(alias:' + emojiPrefix + '_)[0-9]+(_)[0-9]+(_)[0-9a-zA-Z]+$',
  'g'
)
